...
public class frmData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCari = new com.toedter.calendar.JDateChooser();
        ...
        panel1.add(jLabel1);
        jLabel1.setBounds(320, 0, 280, 40);
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No ID", "Nama Pemesan", "Terminal Awal", "Terminal Tujuan", "Tanggal Berangkat", "Jenis Bus", "Waktu Berangkat", "Harga"
            }
        ) {
        ...
        jScrollPane2.setBounds(10, 50, 860, 180);
        ...
        panel1.add(jButton5);
        jButton5.setBounds(170, 240, 90, 40);
        ...
        panel1.add(jButton3);
        jButton3.setBounds(390, 240, 140, 40);
        ...
        panel1.add(jButton4);
        jButton4.setBounds(620, 240, 90, 40);
        ...
        panel1.add(cari);
        cari.setBounds(770, 10, 90, 30);
        panel1.add(txtCari);
        txtCari.setBounds(610, 10, 150, 30);

        getContentPane().add(panel1);
        panel1.setBounds(0, 0, 880, 300);

        setBounds(0, 0, 897, 340);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("Pemesanan Tiket Bus");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (baris != -1) {
            ...
            String SQL = "DELETE FROM tb_pesan where id='"+no+"'";
            int status = 0;
            try {
    ...
    private void cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariActionPerformed
        ...
        String kolom[] = {"id","nama_pemesan","terminal_awal","terminal_tujuan","tanggal_berangkat"
                ,"jenis_bus","waktu_berangkat","harga"};
        DefaultTableModel dtm = new DefaultTableModel(null, kolom);

        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String tanggal = dateFormat.format(txtCari.getDate());

        // String cari = txtCari.getText();
        String SQL = "SELECT * FROM tb_pesan WHERE tanggalBerangkat='"+tanggal+"'";
        ResultSet rs = null;
        try {
        ...
        try {
            while(rs.next()) {
                ...
                String data[] = {ID,Nama,StasiunAwal,StasiunTujuan,Tanggal,JenisKereta,Waktu,Harga};
                dtm.addRow(data);
            }
        } catch (SQLException ex) {
            Logger.getLogger(frmMain.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private com.toedter.calendar.JDateChooser txtCari;
    // End of variables declaration//GEN-END:variables
  public void selectData() {
        String kolom[] = {"id","nama_pemesan","terminal_awal","terminal_tujuan","tanggal_berangkat","jenis_bus"
                ,"waktu_berangkat","harga"};
        DefaultTableModel dtm = new DefaultTableModel(null, kolom);
